          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('inviteOnly')}>
                  Invite Only <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  Participant <FontAwesomeIcon icon="sort" />
                </th>
                <th>
            ...
            <tbody>
              {eventList.map((event, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{event.startDate ? <TextFormat type="date" value={event.startDate} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>{event.endDate ? <TextFormat type="date" value={event.endDate} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>{event.inviteOnly ? 'true' : 'false'}</td>
                  <td>{event.participant ? <Link to={`employee/${event.participant.id}`}>{event.participant.id}</Link> : ''}</td>
                  <td>{event.host ? <Link to={`employee/${event.host.id}`}>{event.host.id}</Link> : ''}</td>
