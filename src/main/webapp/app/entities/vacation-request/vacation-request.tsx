  ...
  return (
    <div className={"col-sm-8 offset-sm-2"}>
      ...
      <div className={"card-columns"}>
        ...
        <div className={`card p-0 ${vacationRequest.status? "border-success" : "border-warning"}`} key={`entity-${i}`}>
          <div className={`card-header d-flex justify-content-between align-items-center mb-3 ${vacationRequest.status? "border-success" : "border-warning"}`}>
