...
import org.relaxedbase.config.ApplicationProperties
...
class RelaxedbaseApp(private val env: Environment) {

    private val log = LoggerFactory.getLogger(javaClass)

    /**
     * Initializes relaxedbase.
     *
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<RelaxedbaseApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(RelaxedbaseApp::class.java)
